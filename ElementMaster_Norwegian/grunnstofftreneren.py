"""
Norwegian version of a game to train elements
"""

import pygame, random, time, pymunk
...
keylist = [pygame.K_a, pygame.K_b, pygame.K_c, pygame.K_d, pygame.K_e, pygame.K_f, pygame.K_g, pygame.K_h, pygame.K_i, pygame.K_j, pygame.K_k, pygame.K_l, pygame.K_m, pygame.K_n, pygame.K_o, pygame.K_p, pygame.K_q, pygame.K_r, pygame.K_s, pygame.K_t, pygame.K_u, pygame.K_v, pygame.K_w, pygame.K_x, pygame.K_y, pygame.K_z, 248, 230, 229]

screen = pygame.display.set_mode((1000, 1000))
clock = pygame.time.Clock()
background_color = pygame.Color(35, 35, 48)
whiteish = pygame.Color(199, 203, 212)
hint_font = pygame.font.SysFont("Times New Roman", round(screen.get_width()/45))
heading_font = pygame.font.SysFont("Times New Roman", round(screen.get_width()/12))
symbol_font = pygame.font.SysFont("Times New Roman", round(screen.get_width()/10))
paragraph_font = pygame.font.SysFont("Times New Roman", round(screen.get_width()/25))
selection_font = pygame.font.SysFont("Times New Roman", round(screen.get_width()/40))
atomic_number_font = pygame.font.SysFont("Times New Roman", round(screen.get_width()/35))
...
while RUNNING:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            # Word input keys
            if event.key in keylist and INGAME:
